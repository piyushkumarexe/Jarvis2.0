...
enum class ActionType { OPEN_APP, OPEN_URL, CLICK, LONG_PRESS, TYPE_TEXT, CLEAR_TEXT, SCROLL, SWIPE, BACK, HOME, WAIT, READ_SCREEN, FIND_ELEMENT, SEARCH, SELECT, PLAY, ADD_TO_CART, INSTALL_APP, CALL, SEND_MESSAGE, SET_VOLUME, SET_BRIGHTNESS, CONFIRM, CANCEL, FINISH }
