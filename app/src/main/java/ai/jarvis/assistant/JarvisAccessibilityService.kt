...
class JarvisAccessibilityService : AccessibilityService() {
    ...
    fun type(text: String): Boolean { val n = rootInActiveWindow?.findFocus(AccessibilityNodeInfo.FOCUS_INPUT) ?: find("search") ?: find("message") ?: return false; val b = Bundle(); b.putCharSequence(AccessibilityNodeInfo.ACTION_ARGUMENT_SET_TEXT_CHARSEQUENCE, text); return n.performAction(AccessibilityNodeInfo.ACTION_SET_TEXT, b) }
